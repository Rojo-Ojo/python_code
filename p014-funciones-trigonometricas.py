...
# Demostrar el uso de funciones trigonométricas y de conversión de grados.

import math as mt

print("\033[2J\033[H", end="")
print("Demostrar el uso de funciones trigonométricas y de conversión de grados.\n")
...
salida = ("\nResumen de funciones trigonométricas y de conversión.\n"
          ...
          f"El ángulo de {angulo} grados, equivale a {radianes:.4f} radianes.\n"
